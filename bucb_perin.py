...
from utils.utils import evaluate_perin_MPO
...
def bayesian_optimization_bucb(
    ...
    for r in range(n_rounds):
        ...
        # Evaluate oracle
        y_batch = evaluate_perin_MPO(batch)[:, 0].tolist()
...
if __name__ == "__main__":
    ...
    for trial_id in range(1, NUM_TRIALS + 1):
        ...
        init_Y = evaluate_perin_MPO(init_smiles)  # shape (10, 1)
